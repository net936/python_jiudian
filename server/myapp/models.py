...
class Thing(models.Model):
    ...
    sfyc = models.CharField(max_length=2, blank=True, null=True)  # 是否有窗
    zaocan = models.CharField(max_length=2, blank=True, null=True)  # 早餐
    status = models.CharField(max_length=1, choices=STATUS_CHOICES, default='0')
    create_time = models.DateTimeField(auto_now_add=True, null=True)
...
class Order(models.Model):
    ...
    receiver_date = models.CharField(max_length=100, blank=True, null=True)  # 预订日期
